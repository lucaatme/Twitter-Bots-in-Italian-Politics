...
df_Berlusconi = pd.read_csv('Berlusconi_NoBotsScenario.csv', sep=',')
df_Conte = pd.read_csv('Conte_NoBotsScenario.csv', sep=',')
df_Fratoianni = pd.read_csv('Fratoianni_NoBotsScenario.csv', sep=',')
df_Salvini = pd.read_csv('Salvini_NoBotsScenario.csv', sep=',')
#df_Letta = pd.read_csv('Letta_NoBotsScenario.csv', sep=',')
#df_Meloni = pd.read_csv('Meloni_NoBotsScenario.csv', sep=',')
...
for polit in politician:
    ...
    ax.set_title('Normalized armonic mean evolution of the use of the words "Ukraine" and "Russia" in the tweets of the real users')

plt.show()

#save the plot
fig.savefig('Slope_Graph_Real_Users.png', dpi=500)
